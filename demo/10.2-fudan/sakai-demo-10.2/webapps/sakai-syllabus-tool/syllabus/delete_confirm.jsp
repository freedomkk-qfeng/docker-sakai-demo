			...
			<div class="alertMessage">
				...
				<sakai:flat_list value="#{SyllabusTool.selectedEntries}" var="eachEntry"  summary="#{msgs.del_conf_listsummary}" styleClass="listHier lines nolines">
					...
					<h:column>
						...
						<h:outputText value="#{msgs[eachEntry.status]}" rendered="#{!eachEntry.statusChanged}"/>
						<h:outputText value="#{msgs[eachEntry.status]}" rendered="#{eachEntry.statusChanged}" styleClass="modified"/>
					</h:column>
					<h:column>
						<f:facet name="header">
