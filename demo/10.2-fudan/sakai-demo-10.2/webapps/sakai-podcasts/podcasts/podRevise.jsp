...
<f:view>
  ...
  <sakai:view toolCssHref="./css/podcaster.css">
	...
	<script type="text/javascript">
		if(sakai.locale.userLocale){
		    document.write("<script type='text/javascript' src='/library/timepicker/localization/jquery-ui-timepicker-"
			     +sakai.locale.userLocale+".js'><\/script>");				
		}
   </script>
