...
<h:form id="overviewForm">
    ...
    <sec:rowGroupTable cellpadding="0" cellspacing="0"
        ...
        columnClasses="leftIndent,left,left,left,left,left,right,right,center"
        rowClasses="groupRow"
        >
        ...
        <h:column>
        	<f:facet name="header">
        		<t:commandSortHeader columnName="notes" immediate="false" arrow="true">
        			<h:outputText value="#{msgs.overview_table_header_notes}" />
        		</t:commandSortHeader>
        	</f:facet>
        	<t:dataList id="meetingNotesList" value="#{section.decoratedMeetings}" var="meeting" layout="simple">
        		<t:div>
        			<h:outputText value="#{meeting.notes}"/>
        		</t:div>
        	</t:dataList>
        </h:column>
        <h:column>
